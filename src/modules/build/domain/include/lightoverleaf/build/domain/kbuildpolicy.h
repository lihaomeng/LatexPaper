...
inline constexpr std::size_t kMaxBuildOverlayBytes = 16 * 1024 * 1024;
inline constexpr std::size_t kMaxBuildOverlayFileBytes = 4 * 1024 * 1024;
inline constexpr std::size_t kMaxBuildOverlayFiles = 32;
