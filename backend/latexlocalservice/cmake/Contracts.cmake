...
set_property(DIRECTORY APPEND PROPERTY CMAKE_CONFIGURE_DEPENDS
  "${LOL_REPO_ROOT}/contracts/rpc/v1/envelope.schema.json"
  "${LOL_REPO_ROOT}/tools/contractcodegen/generate.py"
  "${LOL_REPO_ROOT}/tests/fixtures/ping.json"
  "${LOL_REPO_ROOT}/contracts/rpc/v2/system.schema.json"
  "${LOL_REPO_ROOT}/contracts/rpc/v2/workspace.schema.json"
  "${LOL_REPO_ROOT}/contracts/rpc/v2/document.schema.json"
  "${LOL_REPO_ROOT}/contracts/rpc/v2/search.schema.json"
  "${LOL_REPO_ROOT}/contracts/rpc/v2/build.schema.json"
  "${LOL_REPO_ROOT}/contracts/rpc/v2/preview.schema.json"
  "${LOL_REPO_ROOT}/contracts/rpc/v2/navigation.schema.json"
  "${LOL_REPO_ROOT}/contracts/rpc/v2/preferences.schema.json"
  "${LOL_REPO_ROOT}/contracts/rpc/v2/session.schema.json"
