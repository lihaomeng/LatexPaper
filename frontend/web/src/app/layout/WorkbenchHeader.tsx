...
export function WorkbenchHeader(props: {
  ...
  onHelp(): void; onPreset(value: LayoutPreset): void; onPreview(value: boolean): void;
}) {
  return <header className="topbar">
    <button className="brand" onClick={props.onHelp} title="关于 LightOverLeaf">
      <Icon name="leaf" size={23} /><span>LightOverLeaf</span>
    </button>
    <ActionMenu title="项目菜单" label={<><Icon name="folder" size={16} /><span>项目</span><span className="menu-chevron"><Icon name="chevron" size={12} /></span></>}>
    ...
    <div className="topbar-right">
      <ActionMenu className="align-right" title="工作区布局" label={<><Icon name="split" size={15} /><span>布局</span><span className="menu-chevron"><Icon name="chevron" size={12} /></span></>}>
