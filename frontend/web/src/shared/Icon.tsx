...
const paths: Record<IconName, string> = {
  ...
  settings: "M10 2h4l.6 3 2 .9 2.8-1 2 3.5-2.2 2V13l2.2 2-2 3.5-2.8-1-2 .9-.6 3h-4l-.6-3-2-.9-2.8 1-2-3.5 2.2-2v-2.6l-2.2-2 2-3.5 2.8 1 2-.9z M15.5 12a3.5 3.5 0 1 1-7 0 3.5 3.5 0 0 1 7 0",
